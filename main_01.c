...
int main(void)
{
  ...
  nLis++;
	...
	printf("Testando o método de busca 1 Recursivo de um\n"); 
	printf(" elemento que esta na lista: 201912345\n");
  index = buscaLisAlunoRec(lista_stc, nLis, "201912345");
  if(index < nLis){
  ...
  index = buscaLisAlunoRec(lista_stc, nLis, "201900000");
  if(index < nLis){
    printf("Elemanto achado com índice %d\n", index);
		printItemLisAluno(lista_stc, index);
  }else{
