...
int main(void)
{
  ...
  nLis++;
	...
	printf("Testando o método de busca 2 Recursivo de um\n"); 
	printf(" elemento que esta na lista: 201913425\n");
	strcpy(lista_stc[nLis].numMatricula, "201912345");
	index = buscaLisAlunoRec2(lista_stc, nLis, "201913425");
	if(index < nLis){
	...
	strcpy(lista_stc[nLis].numMatricula, "201900000");
	index = buscaLisAlunoRec2(lista_stc, nLis, "201900000");
	if(index < nLis){
    printf("Elemanto achado com índice %d\n", index);
		printItemLisAluno(lista_stc, index);
  }else{
